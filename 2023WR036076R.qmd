...
post.d18OL <- post.lw.evp.f$BUGSoutput$sims.list$d18OL
post.dDL <- post.lw.evp.f$BUGSoutput$sims.list$dDL
pre.d18OL <- post.lw.evp.f$BUGSoutput$sims.list$pre.d18OL
pre.dDL <- post.lw.evp.f$BUGSoutput$sims.list$pre.dDL
